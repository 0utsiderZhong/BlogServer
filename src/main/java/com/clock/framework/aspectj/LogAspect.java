package com.clock.framework.aspectj;
...
public class LogAspect {
    ...
    @Pointcut("@annotation(com.clock.framework.aspectj.lang.annotation.Log)")
    ...
    /**
     * set the log <code>com.clock.framework.aspectj.lang.annotation.Log</code> other descriptin
     *
     * @param joinPoint  join point
    ...
    /**
     * get annotation of <code>com.clock.framework.aspectj.lang.annotation.Log</code>
     *
     * @param joinPoint join point
     * @return the annotation of <code>com.clock.framework.aspectj.lang.annotation.Log</code>,if can not find will return <code>null</code>
     */
