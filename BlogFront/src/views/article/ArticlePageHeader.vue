<template>
  <div class="article-page-header" v-if="article !== undefined">
    ...
    <Row>
      <Column :xs="24" :sm="10" :md="10" :lg="10" style="padding-left: 0;padding-right: 0;">
        <p class="info">
          <span class="author">Author:  <a href="">Clock</a></span>
          <span class="publish-time">  <a
              href="">{{ article.createTime }}</a></span>
        </p>
      </Column>
      <Column :xs="24" :sm="14" :md="14" :lg="14" style="padding-left: 0;padding-right: 0;">
        <p class="operate_info">
                  <span class="readings">
                    <a>
                      <Icon type="ios-eye"/> {{ article.click }} Reading
                    </a>
                  </span>
          <span class="comments">
                      <a @click="scrollToComments('#comments')">
                        <Icon type="ios-create"></Icon> {{ article.commentList.length }} Comments
                      </a>
                   </span>
          <span class="likes">
