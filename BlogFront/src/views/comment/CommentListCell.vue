<template>
  <div class="comment-list-cell" :id="'comment_'+comment.id">
    <Row :style="{'margin-left':commentLevel==2?'4rem':''}">
      <Column :xs="cellSpan('xs')" :sm="cellSpan('sm')" :md="cellSpan('md')" :lg="cellSpan('lg')"
              :xl="cellSpan('xl')">
        <div class="comment-main">
          <Row :gutter="8">
            <Column :xs="cellLeftSpan('xs')" :sm="cellLeftSpan('sm')" :md="cellLeftSpan('md')"
                    :lg="cellLeftSpan('lg')" :xl="cellLeftSpan('xl')">
              <div class="avatar">
                <img src="../../assets/default_head_img.jpg" v-if="comment.avatar==undefined" alt="">
                <img :src="comment.avatar" v-else alt="">
              </div>
            </Column>
            <Column :xs="cellRightSpan('xs')" :sm="cellRightSpan('sm')" :md="cellRightSpan('md')"
